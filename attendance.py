...
class Attendance: 
    def __init__(self,root):
        ...
        # image 1
        img=Image.open(r"college_images\facescan.jpg")
        ...
        # image 2
        img1=Image.open(r"college_images\facescan.jpg")
        ...
        img_left=Image.open(r"college_images\studentdetails.jpg")
        ...
        left_inside_frame.place(x=0,y=135,width=715,height=370)
        ...
        btn_frame.place(x=0,y=300,width=705,height=35)
